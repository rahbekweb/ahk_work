...
_feltMedDatoAll	:= "WindowsForms10.EDIT.app.0.265601d_r9_ad117"
_feltMedDatoLes	:= "WindowsForms10.EDIT.app.0.265601d_r9_ad112"
...
_imageSearch["navHTflereLinjer"] := "C:/AHK/imageSearch/navHT_webbestilling_flere-linjer.png"
...
salgsordre_check_Telefonnr(){
	...
	if(checkTitle("^Rediger - Salgsordre")){
		...
		if(!RegExMatch(feltMedTelefonnr, "^[0-9]{8}$")){
			...
			MsgBox, 0x1030, Alert!, Telefonnummeret er ikke dansk, se mere på det
